...
model=TSM_CPL_nlldce_${dataset}-in_RGB_resnet50_avg_segment8_e50
...
FeaturePath=${ROOT}/checkpoint/${model}/${feature_mode}/train
TestFeaturePath=${ROOT}/checkpoint/${model}/${feature_mode}/test/
